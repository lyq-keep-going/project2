...
$query = 'SELECT travelimage.ImageID,travelimage.Description,travelimage.Title,travelimage.PATH,travelimagefavor.FavorID
FROM travelimage,traveluser,travelimagefavor
WHERE traveluser.UserName = ?
AND travelimagefavor.UID = traveluser.UID
...
echo json_encode(array('favoritePictures'=>$favoritePictures,'totalPage'=>$totalPage));
